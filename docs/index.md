...
入社後は、研修を経て Java のプロジェクトに約 1 ヶ月間参画した後、自社で展開する Web サービスの開発にフロントエンドエンジニアとして従事しておりました。
...
- 施策  
  ...
  ビデオに関しては、React Player というライブラリを使用し、同じく実装しました。
- 結果  
...
- 施策  
  ...
  具体的には、「学習済みコンテンツ一覧」「学習中コンテンツ一覧」「前回の続き」の大別して 3 つの機能を作成しました。
- 結果  
...
- 課題  
  インフラ研修担当が、受講者の学習進捗を都度 Slack で確認しており、時間の活用方法として大変非効率であるという課題がありました。
- 施策  
  インフラ研修担当が、受講者の学習進捗の一元的に管理できる管理者ページを作成しました。  
  具体的には、「基本プロフィール」「受講者の学習進捗記録」「管理者がユーザに対する所感を記入するメモ」「受講者のスキルを可視化するレーダチャート」の大別して 4 つの機能を実装しました。
- 結果  
